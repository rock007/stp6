...
<li class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('lnkCompany')); ?>:</b>
	<?php echo CHtml::encode($data->lnkCompany); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('lnkUser')); ?>:</b>
	<?php echo CHtml::encode($data->lnkUser); ?>
	<br />
